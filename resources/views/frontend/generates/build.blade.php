                                         ...
                                         <div class="row">
                                            ...
                                            <p class="py-2">
                                               ...
                                               @php  $vid = App\Models\Fal::where('model_type', 'video')->first(); @endphp
                                                ...
                                                <i class="fas fa-video"></i> {{ _('Image to Video') }} </a>
                                        ...
                                        <div class="card-body">
                                         <div class="row">
                                            ...
                                            <p class="py-2">
                                               ...
                                               @php  $vid = App\Models\Fal::where('model_type', 'video')->first(); @endphp
                                                <a class="btn btn-default btn-sm" href="{{ route('frontend.generates.createWithParent', ['model_id' => $vid->id, 'image_id'=>$child->id,'parent_id'=>$generate_id ]) }}">
                                                <i class="fas fa-video"></i> {{ _('Image to Video') }} </a>
                                                ...
                                                <a class="btn btn-default btn-sm" href="{{ route('frontend.generates.createWithParent', ['model_id' => $vid->id, 'image_id'=>$child->id,'parent_id'=>Request::segment(3)]) }}">
                                                   <i class="fas fa-music"></i> {{ _('Add Audio') }}
                                                    </a>
