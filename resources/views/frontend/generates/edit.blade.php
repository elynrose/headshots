    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.generates.update", [$generate->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="prompt">{{ trans('cruds.generate.fields.prompt') }}</label>
                            <textarea class="form-control" name="prompt" id="prompt">{{ old('prompt', $generate->prompt) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="width" id="width" value="{{ old('width', $generate->width) }}" step="1">
                            @if($errors->has('width'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('width') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="height" id="height" value="{{ old('height', $generate->height) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $generate->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="image_url" id="image_url">{{ old('image_url', $generate->image_url) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="content_type" id="content_type" value="{{ old('content_type', $generate->content_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="inference" id="inference" value="{{ old('inference', $generate->inference) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="seed" id="seed" value="{{ old('seed', $generate->seed) }}">
                            @if($errors->has('seed'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('seed') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="credit" id="credit" value="{{ old('credit', $generate->credit) }}" step="1">
