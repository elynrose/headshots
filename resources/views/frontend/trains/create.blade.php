                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.trains.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="requestid" id="requestid" value="{{ old('requestid', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="diffusers_lora_file" id="diffusers_lora_file">{{ old('diffusers_lora_file') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="config_file" id="config_file">{{ old('config_file') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="file_size" id="file_size" value="{{ old('file_size', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="error_log" id="error_log" value="{{ old('error_log', '') }}">
