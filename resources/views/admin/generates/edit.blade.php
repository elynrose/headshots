...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.generate.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.generates.update", [$generate->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="prompt">{{ trans('cruds.generate.fields.prompt') }}</label>
                <textarea class="form-control {{ $errors->has('prompt') ? 'is-invalid' : '' }}" name="prompt" id="prompt">{{ old('prompt', $generate->prompt) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('width') ? 'is-invalid' : '' }}" type="number" name="width" id="width" value="{{ old('width', $generate->width) }}" step="1">
                @if($errors->has('width'))
                    <div class="invalid-feedback">
                        {{ $errors->first('width') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $generate->height) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $generate->status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('image_url') ? 'is-invalid' : '' }}" name="image_url" id="image_url">{{ old('image_url', $generate->image_url) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('content_type') ? 'is-invalid' : '' }}" type="text" name="content_type" id="content_type" value="{{ old('content_type', $generate->content_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inference') ? 'is-invalid' : '' }}" type="text" name="inference" id="inference" value="{{ old('inference', $generate->inference) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seed') ? 'is-invalid' : '' }}" type="text" name="seed" id="seed" value="{{ old('seed', $generate->seed) }}">
                @if($errors->has('seed'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seed') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit') ? 'is-invalid' : '' }}" type="number" name="credit" id="credit" value="{{ old('credit', $generate->credit) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id" required>
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $generate->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
                    <div class="invalid-feedback">
