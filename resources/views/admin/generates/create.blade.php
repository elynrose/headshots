...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.generates.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('image_url') ? 'is-invalid' : '' }}" name="image_url" id="image_url">{{ old('image_url') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inference') ? 'is-invalid' : '' }}" type="text" name="inference" id="inference" value="{{ old('inference', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seed') ? 'is-invalid' : '' }}" type="text" name="seed" id="seed" value="{{ old('seed', '') }}">
                @if($errors->has('seed'))
                    <div class="invalid-feedback">
                        {{ $errors->first('seed') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit') ? 'is-invalid' : '' }}" type="number" name="credit" id="credit" value="{{ old('credit', '1') }}" step="1">
