    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.trains.update", [$train->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('requestid') ? 'is-invalid' : '' }}" type="number" name="requestid" id="requestid" value="{{ old('requestid', $train->requestid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $train->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $train->status) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('diffusers_lora_file') ? 'is-invalid' : '' }}" name="diffusers_lora_file" id="diffusers_lora_file">{{ old('diffusers_lora_file', $train->diffusers_lora_file) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('config_file') ? 'is-invalid' : '' }}" name="config_file" id="config_file">{{ old('config_file', $train->config_file) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_size') ? 'is-invalid' : '' }}" type="text" name="file_size" id="file_size" value="{{ old('file_size', $train->file_size) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('error_log') ? 'is-invalid' : '' }}" type="text" name="error_log" id="error_log" value="{{ old('error_log', $train->error_log) }}">
