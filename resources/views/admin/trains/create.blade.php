...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.train.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.trains.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="requestid">{{ trans('cruds.train.fields.requestid') }}</label>
                <input class="form-control {{ $errors->has('requestid') ? 'is-invalid' : '' }}" type="number" name="requestid" id="requestid" value="{{ old('requestid', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('diffusers_lora_file') ? 'is-invalid' : '' }}" name="diffusers_lora_file" id="diffusers_lora_file">{{ old('diffusers_lora_file') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('config_file') ? 'is-invalid' : '' }}" name="config_file" id="config_file">{{ old('config_file') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_size') ? 'is-invalid' : '' }}" type="text" name="file_size" id="file_size" value="{{ old('file_size', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('error_log') ? 'is-invalid' : '' }}" type="text" name="error_log" id="error_log" value="{{ old('error_log', '') }}">
