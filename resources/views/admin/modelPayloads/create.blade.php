...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.modelPayload.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.model-payloads.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('payload_template') ? 'is-invalid' : '' }}" name="payload_template" id="payload_template">{{ old('payload_template') }}</textarea>
